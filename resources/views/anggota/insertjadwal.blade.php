...
<div class="container-fluid">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Insert Jadwal Status</h1>
      </div>
      ...
      <div class="mb-3">
        ...
        <input name="anggota_id" type="text" class="form-control" id="user_id" value="{{ $anggota->nama }} " >
        @error('anggota_id')
      ...
      <div class="mb-3">
        <label for="jadwal_id" class="form-label">jadwal_id</label>
        <input name="jadwal_id" type="text" class="form-control" id="jadwal_id" placeholder="Ketikkan jadwal id" value=" " >
        @error('jadwal_id')
        <div class="alert alert-danger mt-2">
        {{ $message }}
        </div>
